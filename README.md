...
<p align="center">
    <img src="./images/classic-web-site.png" alt="Classic web-site diagram on multi-cloud" width="300"/>
</p>
...
<p align="center">
    <img src="./images/centralized-db.png" alt="Web-site with centralized DB" width="300"/>
</p>
Examples that could help to build that architecture:

* setting up replication between databases based on PostgreSQL [here](link) 

* also it could be beneficial to establish VPN connection for more secure connectivity. VPN example is [here](link) 

* or even establish a Direct Connect, example is [here]()
...
<p align="center">
    <img src="./images/data-lake.png" alt="Centralized Data-lake or DataWarehouse" width="300"/>
</p>
Examples that could help to build that architecture:

* Yandex function that sync data between clouds, [here](link)

* also it could be beneficial to establish VPN connection for more secure connectivity. VPN example is [here](link)

### **Kubernetes Applications on multi clouds**
Kubernetes is curretnly extremly popular techonology to build apps. That example could show you how you can build distributed app based on Kubernetes. The state of the app that stored in database could also be synced. You can also enrich that architecture by using [KubeFed project](link) or Istio to establish federation of Kubernetes resources between clusters.    
<p align="center">
    <img src="./images/kubernetes.png" alt="Distributed Kubernetes app" width="300"/>
</p>
Examples that could help to build that architecture:
...
* Inventory and etc
<p align="center">
    <img src="./images/management.png" alt="Fleet management" width="300"/>
</p>
Examples that could help to build that architecture:

* [Example and automation for managing instances in Yandex.Cloud using AWS Systems Manager](link)

* [Automation for VPN between Yandex.Cloud and AWS](link)
